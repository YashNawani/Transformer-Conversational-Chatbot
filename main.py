...
def evaluate(hparams, model, tokenizer,sentence):
  print('\nEvaluate')
  output = predict(hparams, model, tokenizer, sentence)
  
  return output
  # sentence = "it's a trap!"
  # output = predict(hparams, model, tokenizer, sentencee)
  # print('\ninput: {}\noutput: {}'.format(sentencee, output))
